        ...
        GeometryReader { geo in
            ...
            ZStack {
                ...
                VStack(spacing: 0) {
                    ...
                    VStack(spacing: 16) {
                        Text("Pas Sûr De\nTon Humeur ?")
                            .font(.patchiDisplay(min(w * 0.102, 42), weight: .semibold))
                            .foregroundStyle(.black)
                            .multilineTextAlignment(.center)

                        Text("Prends un moment pour toi et reconnecte\ntoi à tes émotions.")
                            .font(.patchiDisplay(min(w * 0.041, 16), weight: .regular))
                    ...
                    Button {
                        ...
                        Text("Continuer")
                            .font(.patchiDisplay(20, weight: .semibold))
                ...
                VStack(spacing: 0) {
                    ...
                    VStack(spacing: 12) {
                        ...
                        HStack(spacing: 10) {
                            ...
                            Button {
                                ...
                                HStack(spacing: 8) {
                                    ...
                                    Text("Google")
                                        .font(.patchiDisplay(14, weight: .semibold))
                        ...
                        Text("En continuant, tu acceptes nos CGU et notre politique de confidentialité.")
                            .font(.patchiDisplay(11, weight: .regular))
        ...
        VStack(spacing: 32) {
            ...
            VStack(spacing: 16) {
                ...
                Button {
                    ...
                    Text("C'est parti")
                        .font(.patchiDisplay(18, weight: .semibold))
                        .foregroundStyle(.white)
                        .frame(maxWidth: .infinity)
                        .frame(height: 58)
                        .background(Color(red: 0.059, green: 0.059, blue: 0.059))
